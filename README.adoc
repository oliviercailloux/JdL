...
| 15h00 | Nouveaux doctorants du Lamsade : Timothée SOHM-QUERON (confirmé) ; Hajer BEN FEKIH (confirmé) ; Axel FAURE BEAULIEU (confirmé) ; Beatrice NAPOLITANO (confirmé) ; Pierre CAZALS (confirmé) ; Felipe GARRIDO LUCERO ; Alexis DUBURCQ ; Eric BENHAMOU ; Guillaume PREVOST ; Paul Alain KALDJOB KALDJOB ; Laurent MEUNIER 
|===
